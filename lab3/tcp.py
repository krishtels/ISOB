class TCP:
    def __init__(self, source_port, destination_port, ip):
        ...
        self.sequence = 0
        self.acknowledgment = 0 #ACK
        self.offset = 20
        self.ns = None #Nonce Sum

        # Reserved
        self.cwr = None #Congestion Window Reduce
        self.ece = None #ENC-Echo

        # Flags
        self.urg = None #Urgent pointer
        self.ack = False
        self.psh = None
        self.rst = False #Reset
        self.syn = False
        self.fin = False
